namespace SplitTime.conversation {
    ...
    export interface SectionChainInterruptible {
         ...
         */
        interruptible(condition?: condition_t, sectionSetup?: () => void): SectionChainInterruptible;
        /**
         * The modified section can be interrupted when the body is detected by some speaker
         */
        interruptibleByDetection(condition?: condition_t, sectionSetup?: () => void, body?: Body): SectionChainInterruptible;
    }
}