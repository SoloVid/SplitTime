namespace SplitTime.conversation {
    export class LineRunner {
        ...
        constructor(private readonly parentSection: Section, private readonly helper: OrchestrationHelper, private readonly line: Line) {
            this.dialog = new SpeechBubble(this.parentSection.clique, this.line.speaker.name, this.line.line, this.line.speaker.speechBox);
            this.outcome = {
                canceled: false,
                interrupted: true
            }
        ...
        private registerHandlers() {
            ...
            for(const speaker of this.speakers) {
                speaker.body.registerPlayerInteractHandler(() => this.onInteract());
                // FTODO: refactor
        ...
        private deregisterHandlers() {
            for(const speaker of this.speakers) {
                speaker.body.deregisterPlayerInteractHandler(() => this.onInteract());
            }
        }
