 ...
 * @constructor
 */
SplitTime.Body.Transporter = function(body) {
    this.body = body;
};
 ...
 */
SplitTime.Body.Transporter.prototype.transportLevelIfApplicable = function(levelId) {
 ...
 */
SplitTime.Body.Transporter.prototype._theNextTransport = function(levelFrom, levelIdTo, x, y, z) {
