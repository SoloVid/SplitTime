    ...
    export class DataSortedByOneValue {
        ...
        resortUpward(ref: number, value: number) {
            ...
            while (
                ...
                this.reverseSortLookup[
                    this.sortedByValue[currentIndex].ref
                ] = currentIndex
                currentIndex++
            }
            ...
            var index32AboveOldValue =
                Math.floor(oldValue / this.bucketSize) + 1
        ...
        forEachInRange(
            ...
            var iSortedEnd =
                index32 + 1 < this.valueLookup32.length
        ...
        forEachInList(callback: (arg0: object) => any): boolean {
            ...
            for (
                var iSorted = 0;
                iSorted < this.sortedByValue.length;
                iSorted++
            ) {
                var sortedItem = this.sortedByValue[iSorted]
