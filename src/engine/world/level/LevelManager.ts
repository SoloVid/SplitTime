namespace SplitTime {
    type transition_listener = (oldLevel: Level | null, newLevel: Level) => PromiseLike<any>;
    ...
    export class LevelManager {
        ...
        */
        async transition(level: Level): Promise<any> {
            ...
            var changeRegion = !exitingLevel || exitingLevel.getRegion() !== enteringLevel.getRegion();
