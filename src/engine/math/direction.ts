...
namespace SplitTime.direction {
	...
	export function fromToThing(fromThing: {x: number, y: number}, toThing: {x: number, y: number}): direction_t;
	...
	export function areWithin90Degrees(dir1: direction_t, dir2: direction_t, howMany90Degrees: int = 1): boolean {
