namespace splitTime.light {
    ...
    export class Gradient {
        ...
        getColorAt(offset: number): Color {
            ...
            return new Color(
                stop1.color.r * stop1Weight + stop2.color.r * stop2Weight,
                stop1.color.g * stop1Weight + stop2.color.g * stop2Weight,
                stop1.color.b * stop1Weight + stop2.color.b * stop2Weight,
            )
        }
    }
}