...
import { GroupNode, Node, TestNode } from "./test-tree"
...
export class WorkerTestRunner {
    ...
    private readonly promise = new Pledge()
    private totalTests: number = 0
    private testsCompleted: number = 0

    constructor(id: number, scriptPath: string, node: GroupNode | TestNode) {
    ...
    private findTestById(id: string, node: Node): TestNode | null {
