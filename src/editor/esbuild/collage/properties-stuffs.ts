...
import { getTracePropertiesStuff as getTracePropertiesStuffShared } from "../trace-properties"
...
export function getObjectProperties(collage: Immutable<Collage>, setCollage: ImmutableSetter<Collage>, path: BasePath): GenericObjectProperties {
    ...
    if (path[0] === "frames") {
        ...
        const properties: ObjectProperties<SimplifiedFrame, ["frames", number]> = {
            // TODO: More type safety?
            ...baseProperties as any,
            title: "Frame Properties",
            fields: frameFieldObject,
    ...
    if (path[0] === "montages") {
        ...
        if (path.length === 2) {
            const properties: ObjectProperties<SimplifiedMontage, ["montages", number]> = {
                // TODO: More type safety?
                ...baseProperties as any,
                title: "Montage Properties",
                fields: montageFieldObject,
        ...
        if (path[2] === "frames") {
            ...
            const properties: ObjectProperties<SimplifiedMontageFrame, ["montages", number, "frames", number]> = {
                // TODO: More type safety?
                ...baseProperties as any,
                title: "Montage Frame Properties",
                fields: montageFrameFieldObject,
