namespace splitTime.math {
    splitTime.test.scenario(math, "fillPolygon() with square", t => {
    ...
    splitTime.test.scenario(math, "fillPolygon() with diamond", t => {
    ...
    splitTime.test.scenario(math, "fillPolygon() with hourglass", t => {
