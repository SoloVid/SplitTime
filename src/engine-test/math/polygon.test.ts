...
math.scenario("Polygon#findPointToward() with square", t => {
...
math.scenario("Polygon#findPointToward() with diamond", t => {
...
math.scenario("Polygon#findPointToward() with triangle", t => {
